package org.jsp.event_App.configuration;
...
public class SwaggerConfiguration {
	...
	public OpenAPI usersMicroserviceOpenAPI() {
		...
		License mitLicense = new License().name("MIT License").url("https://localhost:8080/events");
		Info info = new Info().title("Event Management").version("1.0")
